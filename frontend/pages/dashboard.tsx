...
export default function Dashboard() {
  ...
  const [section, setSection] = useState<'summary' | 'profile' | 'logins'>('summary');
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-indigo-600 pl-4 py-2">
                ...
                <div className="text-sm text-gray-500">{t('current_session')}</div>
              </div>
              <div className="border-l-4 border-gray-300 pl-4 py-2">
                <div className="text-sm font-medium text-gray-900">{formatDate(user.created_at)}</div>
                <div className="text-sm text-gray-500">{t('initial_login')}</div>
              </div>
            </div>
          </div>
